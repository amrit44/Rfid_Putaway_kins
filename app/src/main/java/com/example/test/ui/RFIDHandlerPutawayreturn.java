...
class RFIDHandlerPutawayreturn implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private Putawaydispatchreturn context;
    // general
    ...
    void onCreate(Putawaydispatchreturn activity) {
        // application context
        context = activity;
        // Status UI
